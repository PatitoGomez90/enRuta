...
function getById(id, cb){
	conn("select partediario1.*, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion1_fk) as clasificacion1txt, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion2_fk) as clasificacion2txt, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion3_fk) as clasificacion3txt, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion4_fk) as clasificacion4txt, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion5_fk) as clasificacion5txt, (select nombre from clasificacion_hora where clasificacion_hora.id = partediario1.id_clasificacion6_fk) as clasificacion6txt, (select numero from items where items.id = partediario1.id_imputacion1_fk) as imputacion1txt, (select numero from items where items.id = partediario1.id_imputacion2_fk) as imputacion2txt, (select numero from items where items.id = partediario1.id_imputacion3_fk) as imputacion3txt, (select numero from items where items.id = partediario1.id_imputacion4_fk) as imputacion4txt, (select numero from items where items.id = partediario1.id_imputacion5_fk) as imputacion5txt, (select numero from items where items.id = partediario1.id_imputacion6_fk) as imputacion6txt, DATE_FORMAT(partediario1.fecha, '%d/%m/%Y') as fechaf, lugares.nombre as lugartxt, sectores.nombre as sectortxt from partediario1 left join lugares on lugares.id = partediario1.id_lugar_fk left join sectores on sectores.id = partediario1.id_sector_fk where partediario1.id="+id, cb);
}
